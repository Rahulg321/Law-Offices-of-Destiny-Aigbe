  ...
  return (
    ...
    >
      <div className="narrow-container text-pretty heading-content">
        ...
        <div className="mt-4 md:mt-6 lg:mt-8 prose md:prose-lg lg:prose-xl prose-p:text-white prose-ul:text-white w-full max-w-none dark:prose-invert prose-img:rounded-xl prose-headings:underline prose-headings:text-white merriFont prose-a:text-blue-600 prose-strong:text-white prose-strong:font-bold">
